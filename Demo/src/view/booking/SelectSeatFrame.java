...
import view.booking.BookingConfirmationFrame;
import controller.booking.SeatController;
...
public class SelectSeatFrame extends JFrame {
    ...
    public SelectSeatFrame(ShowTime showTime, List<String> previousSelectedSeats) {
        ...
        try {
            bookedSeats = seatController.loadBookedSeats(currentShowTime.getId());
            if (bookedSeats == null) throw new Exception("Lỗi đọc file ghế");
        } catch (Exception e) {

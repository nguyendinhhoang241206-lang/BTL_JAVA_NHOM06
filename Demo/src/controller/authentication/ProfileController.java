...
import service.authentication.ProfileService;
import view.authentication.ProfileForm;
        ...
        view.getBtnRequestAdmin().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (loggedInUser.getRole() == Role.ADMIN) {
                    ...
                    view.authentication.AccountManagementForm manageForm = new view.authentication.AccountManagementForm();
                    manageForm.setDefaultCloseOperation(javax.swing.JFrame.DISPOSE_ON_CLOSE);
                    new AccountManagementController(manageForm, loggedInUser);
